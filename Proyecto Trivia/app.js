...
//Variable "i" para el contador final
var i= 0;
...
//pregunta9
    var question9 = prompt ("Selecciona el inciso correcto: \n9.- ¿Qué personaje es reconocido por exclamar '¡Mi pierna!'?\n\na) Larry \nb) Patricio \nc) Fred \nd) Calamardo")
...
document.getElementById('title').innerHTML = ("Bienvenid@ " + userName);

document.getElementById("final").innerHTML = ("Estos son tus resultados: " + i + " /10");

document.getElementById("score").innerHTML = (score)

//Switch para determinar una evaluación con base en las respuestas correctas e incorrectas. 
    switch (i) {
        case 0:
        case 1:
        case 2:
        document.getElementById("score").innerHTML =  "No estás listo para esta conversación  u.u";        
            break;
        case 3:
        case 4:
        document.getElementById("score").innerHTML =  "Tal vez sea estupido, pero también es tonto";
            break;
        case 5:
        case 6:
        document.getElementById("score").innerHTML =  "Te hace falta ver más Bob";
            break;
        case 7:
        case 8:
        document.getElementById("score").innerHTML =  "¡Muy bien! Los pensamientos en tu mente son un enigma";
          break;
        case 9:
        case 10:
        document.getElementById("score").innerHTML =  "¡Excelente! ¡Permitame estrechar su mano de poeta a poeta!";
        default:
          break;
      }